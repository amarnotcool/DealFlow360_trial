...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Subscriptions', to: '/subscriptions', enabled: true, icon: <Glyph d="M4 12a8 8 0 0113.7-5.6M20 12a8 8 0 01-13.7 5.6M18 4v4h-4M6 20v-4h4" /> },
  { label: 'Invoices', to: '/invoices', enabled: true, icon: <Glyph d="M6 3h12v18l-3-2-3 2-3-2-3 2zM9 8h6M9 12h6" /> },
