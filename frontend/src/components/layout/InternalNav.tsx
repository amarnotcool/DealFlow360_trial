...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Fulfillment', to: '/fulfillment', enabled: false, icon: <Glyph d="M3 8h11v9H3zM14 11h4l3 3v3h-7zM7 20a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM18 20a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" /> },
